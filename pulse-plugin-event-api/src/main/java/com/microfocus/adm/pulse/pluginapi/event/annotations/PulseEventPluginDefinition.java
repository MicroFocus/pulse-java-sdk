...
package com.microfocus.adm.pulse.pluginapi.event.annotations;
 ...
 * {@linkplain com.microfocus.adm.pulse.pluginapi.event.PulseEventPlugin} that are packaged in a spar file. It
 * provides default values for <code>groupId</code>, <code>pluginId</code>, <code>version</code>, <code>displayName</code> and
 * <code>description</code> so that the plugin descriptor file, <em>plugin.json</em>, only needs to contain the plugin's
 * <code>className</code>.
 * </p>
 *
 * @since 19.1.1
...
public @interface PulseEventPluginDefinition {
    /**
     * <p>
