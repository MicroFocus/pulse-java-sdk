...
import com.microfocus.adm.pulse.pluginapi.chain.dto.PulseEmail;

/**
 * <p>
 * Used to create emails that will be sent using {@link PulseEmailReporter}.
 * </p>
 * <p>
...
public interface PulseEmailBuilder {
     ...
     * must be provided in to(List) or {@link #cc(List)} or {@link #bcc(List)} methods to successfully build an email. Attempting to
     * build an email with no recipients will result in an {@link IllegalStateException} being thrown by the {@link #build()}
     * method.
     * </p>
     *
     * @param recipients
     ...
     * must be provided in {@link #to(List)} or cc(List) or {@link #bcc(List)} methods to successfully build an email. Attempting to
     * build an email with no recipients will result in an {@link IllegalStateException} being thrown by the {@link #build()}
     * method.
     * </p>
     *
     ...
     * must be provided in {{@link #to(List)} or {@link #cc(List)} or bcc(List) methods to successfully build an email. Attempting
     * to build an email with no recipients will result in an {@link IllegalStateException} being thrown by the {@link #build()}
     * method.
     * </p>
     *
     * @param recipients
